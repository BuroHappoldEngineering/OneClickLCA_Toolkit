...
namespace BH.Engine.Adapters.OneClickLCA
{
    public static partial class Compute
    {
        ...
        [Input("calculationResults", "Calculation results list to calculate from.")]
        ...
        public static ClimateChangeTotalMetric ClimateChangeTotalMetric(List<CalculationResult> calculationResults)
        {
